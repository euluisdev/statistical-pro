...
import styles from "./chartcppieces.module.css";
  ...
  if (!piecesData || !chartData) {
    return (
      <div className={styles.emptyContainer}>
        <p>📊 Gere o relatório da semana {selectedWeek}/{selectedYear} para visualizar o CP por peça</p>
      </div>
    );
  }
        ...
        <Plot
          ...
          config={{
            ...
            toImageButtonOptions: {
              format: "png",
              filename: `CP_Por_Peca_${group}_${selectedYear}_W${selectedWeek}`,
              height: 800,
              width: 1400,
              scale: 2,
            },
